...
from english_parser import English_Parser
...
class Initialize_C_Matrix(object):
    ...
    def initializeC(self,timeInterval):
        self.lines,timeLength,self.vocabulary=English_Parser().run("../Datasets/scripts/final.json", 1180)
        preTime=0
    ...
    def store_lineno_list(self):
        ...
        fv = open("../linesno_list2.json", "wb")
        json.dump(self.lineno_list, fv)
